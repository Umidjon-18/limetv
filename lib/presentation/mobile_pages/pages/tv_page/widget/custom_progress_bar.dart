...
class CustomVideoProgressBar extends StatelessWidget {
  ...
  final ProgressBarSettings progressBarSettings;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, size) {
      return GestureDetector(
        ...
        child: Container(
          width: size.maxWidth,
          padding: progressBarSettings.padding,
          child: Container(
            height: progressBarSettings.height,
            child: CustomPaint(
